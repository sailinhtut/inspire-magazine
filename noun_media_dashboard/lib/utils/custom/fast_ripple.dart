...
const Duration _kRadiusDuration = Duration(milliseconds: 150);
...
class _InkRippleFastFactory extends InteractiveInkFeatureFactory {
  const _InkRippleFastFactory();
...
/// is used when the [Theme]'s [ThemeData.splashFactory] is [InkRippleFast.splashFactory].
///
/// See also:
///
...
///    [Material].
class InkRippleFast extends InteractiveInkFeature {
  ...
  static const InteractiveInkFeatureFactory splashFactory = _InkRippleFastFactory();
